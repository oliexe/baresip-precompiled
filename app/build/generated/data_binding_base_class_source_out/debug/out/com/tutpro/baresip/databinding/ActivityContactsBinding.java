...
public final class ActivityContactsBinding implements ViewBinding {
  ...
  private ActivityContactsBinding(@NonNull RelativeLayout rootView, @NonNull ListView contacts,
  ...
  public static ActivityContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactsBinding((RelativeLayout) rootView, contacts, plusButton);
    }
